...
- ✅ **Affichage de texte** (X) - Bloc informatif DSFR
...
- ✅ **CAPTCHA** - Google reCAPTCHA intégré avec fix reload loop
...
- ✅ **32 templates printanswers** - Tous les types de questions
...
- ✅ **Linéarisation tableaux** - Tableaux adaptés mobile (display: block)
- ✅ **20 helpers grille** - Gutters, alignements, offset (dsfr-grid-helpers.css)
- ✅ **Images responsives** - fr-responsive-img

#### Personnalisation

- ✅ **Logo opérateur** - Upload SVG/PNG dans header (width: 6rem)
- ✅ **Logo Marianne** - Drapeau + bloc "Liberté Égalité Fraternité"
...
- ✅ **IE11 fallback** - JS nomodule pour anciens navigateurs
- ✅ **Sans CDN** - Fonctionne hors ligne (ressources locales)
...
Le fichier standard `dsfr.min.css` contient des data-URI (SVG encodés en base64) qui sont **bloqués par les Content Security Policy (CSP)** strictes en production.
